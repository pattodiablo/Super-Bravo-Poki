...
class LevelMap extends Phaser.Scene {
	...
	create() {
		...
		this.editorCreate();
		this.supaPoints = [
			{x:this.cameras.main.centerX,y:this.cameras.main.height+60},
			{x:this.cameras.main.centerX,y:this.cameras.main.height-20},
			{x:this.cameras.main.centerX,y:this.cameras.main.height-60},
			{x:this.cameras.main.centerX+30,y:this.cameras.main.height-100},
			{x:this.cameras.main.centerX+30,y:this.cameras.main.height-140},
			{x:this.cameras.main.centerX-20,y:this.cameras.main.height-170},
			{x:this.cameras.main.centerX-20,y:this.cameras.main.height-200},
			{x:this.cameras.main.centerX+33,y:this.cameras.main.height-235},
			{x:this.cameras.main.centerX+33,y:this.cameras.main.height-280},
			{x:this.cameras.main.centerX,y:this.cameras.main.height-330},
			{x:this.cameras.main.centerX,y:this.cameras.main.height-380}];
		this.defaultLevel = 0;
